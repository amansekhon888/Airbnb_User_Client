            ...
            <div>
                <div className='grid xl:grid-cols-2 gap-4 mt-5'>
                    <div className='flex items-center justify-between gap-4 border border-border1 px-3 py-2 rounded-md'>
                        <label htmlFor="" className='text-text1 text-sm'>Number of Bedrooms</label>
                        <div className="flex items-center gap-3">
                            <button className='text-smfont-bold w-5 h-5 flex items-center justify-center border border-text1 rounded-md opacity-30' disabled><Remove className='!text-sm' /></button>
                    ...
                    <div className='flex items-center justify-between gap-4 border border-border1 px-3 py-2 rounded-md'>
                        <label htmlFor="" className='text-text1 text-sm'>Number of Beds</label>
                        <div className="flex items-center gap-3">
                    ...
                    <div className='flex items-center justify-between gap-4 border border-border1 px-3 py-2 rounded-md'>
                        <label htmlFor="" className='text-text1 text-sm'>Maximum Guests</label>
                        <div className="flex items-center gap-3">
                            <button className='text-text1 font-bold w-5 h-5 flex items-center justify-center border border-text1 rounded-md'><Remove className='!text-sm' /></button>
                            <span className='text-text1 font-bold'>1</span>
                            <button className='text-text1 font-bold w-5 h-5 flex items-center justify-center border border-text1 rounded-md'><Add className='!text-sm' /></button>
                    ...
                    <div className='flex items-center justify-between gap-4 border border-border1 px-3 py-2 rounded-md'>
                        <label htmlFor="" className='text-text1 text-sm'>Number of Bathrooms</label>
                        <div className="flex items-center gap-3">
                            <button className='text-text1 font-bold w-5 h-5 flex items-center justify-center border border-text1 rounded-md'><Remove className='!text-sm' /></button>
                            <span className='text-text1 font-bold'>1</span>
                            <button className='text-text1 font-bold w-5 h-5 flex items-center justify-center border border-text1 rounded-md'><Add className='!text-sm' /></button>
                    ...
                    Amenities.map((amenity, index) => (
                        <>
                            ...
                            <div key={index}>
                                ...
                                <div className='grid grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 gap-4 mt-5'>
                                    {
                                        amenity.items.map((item, index) => (
                                            <div key={index} className='flex items-center gap-2'>
                                                <input type="checkbox" name="" id="" className='rounded' />
                                                <label htmlFor="" className='text-text1 text-sm'>{item}</label>
                                            </div>
                                        ))
                                    }
                                </div>
