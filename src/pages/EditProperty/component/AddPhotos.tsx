    ...
    return (
        <div>
            ...
            <div className='border border-border1 rounded-md p-4'>
                <div className="grid grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 4xl:grid-cols-3 gap-2 sm:gap-4">
                    <div className='h-[180px] sm:h-[200px] relative border-[3px] border-primary rounded-xl overflow-hidden '>
                        ...
                        <div className="absolute top-2 right-2" ref={dropdownRef}>
                            ...
                            {isDropdownOpen && (
                                <div className="absolute top-8 right-0 w-max bg-white shadow-md rounded-md py-2 border border-gray-00">
                    ...
                    <div className='h-[180px] sm:h-[200px] relative'>
                        ...
                        <div className="px-3 absolute bottom-3 w-full">
                            <select name="" id="" className="w-full text-sm bg-white border border-border1 rounded-md px-2 py-1.5 mt-2">
                    ...
                    <div className='h-[180px] sm:h-[200px] relative'>
                        <label htmlFor="file" className="w-full h-full cursor-pointer border border-border1 rounded-xl flex flex-col gap-2 items-center justify-center">
